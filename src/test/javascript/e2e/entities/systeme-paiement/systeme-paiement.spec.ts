...
describe('SystemePaiement e2e test', () => {
  ...
  it('should load SystemePaiements', async () => {
    ...
    expect(await systemePaiementComponentsPage.getTitle()).to.eq('dmglApp.systemePaiement.home.title');
    await browser.wait(
  ...
  it('should load create SystemePaiement page', async () => {
    ...
    expect(await systemePaiementUpdatePage.getPageTitle()).to.eq('dmglApp.systemePaiement.home.createOrEditLabel');
  ...
  it('should delete last SystemePaiement', async () => {
    ...
    expect(await systemePaiementDeleteDialog.getDialogTitle()).to.eq('dmglApp.systemePaiement.delete.question');
