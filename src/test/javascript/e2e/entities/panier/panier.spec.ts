...
describe('Panier e2e test', () => {
  ...
  it('should load Paniers', async () => {
    ...
    expect(await panierComponentsPage.getTitle()).to.eq('dmglApp.panier.home.title');
  ...
  it('should load create Panier page', async () => {
    ...
    expect(await panierUpdatePage.getPageTitle()).to.eq('dmglApp.panier.home.createOrEditLabel');
  ...
  it('should delete last Panier', async () => {
    ...
    expect(await panierDeleteDialog.getDialogTitle()).to.eq('dmglApp.panier.delete.question');
