...
describe('Roles e2e test', () => {
  ...
  it('should load Roles', async () => {
    ...
    expect(await rolesComponentsPage.getTitle()).to.eq('dmglApp.roles.home.title');
  ...
  it('should load create Roles page', async () => {
    ...
    expect(await rolesUpdatePage.getPageTitle()).to.eq('dmglApp.roles.home.createOrEditLabel');
  ...
  it('should delete last Roles', async () => {
    ...
    expect(await rolesDeleteDialog.getDialogTitle()).to.eq('dmglApp.roles.delete.question');
